...
export const MahsulotData: IMahsulot[] = [
  ...
  createMahsulotData(10, 3, "Milkshake", 23000, "Creamy vanilla milkshake"),
  createMahsulotData(
    11,
    3,
    "Soda",
  ...
  createMahsulotData(12, 3, "Iced Tea", 14000, "Chilled brewed tea with lemon"),
  createMahsulotData(
    13,
    1,
    "Fish Sandwich",
  ...
  createMahsulotData(14, 1, "BBQ Ribs", 55000, "Tender ribs with BBQ sauce"),
  createMahsulotData(
    15,
    2,
    "Garden Salad",
  ...
  createMahsulotData(29, 3, "Lemonade", 14000, "Freshly squeezed lemonade"),
  createMahsulotData(
    30,
    3,
    "Smoothie",
...
export const HodimlarData: IHodim[] = [
  createHodimData(1, "Malika", "Komilova", "+998991457486", "Operator"),
  createHodimData(2, "Husnora", "Jalolova", "+998944865921", "Operator"),
  createHodimData(3, "Durdona", "Akmalova", "+998334589657", "Operator"),
];
